...
ui <- fluidPage(theme = shinytheme("darkly"),
                ...
                tabsetPanel(id = "inTabset",
                            ...
                            tabPanel("About", 
                                ...
                                <br><br>
                                <i class="fas fa-arrow-alt-circle-right"></i>&emsp;
                                Speed of the eagle increases with each correct answer and decreases with each incorrect answer. Within a time limit of 2 minutes, The player has to make the math eagle reach outer space by boosting his speed.
                                <br><br>'
                                           ),
                                           ...
                                           HTML('
                                <i class="fas fa-arrow-alt-circle-right"></i>&emsp;
                                The app has been developed by Sharuk khan, the app is powered by Shiny and packages like shiny, shinydashboard, shinythemes, shinyjs.
                                
                                <br>&emsp;&emsp;
                                <i class="far fa-arrow-alt-circle-right"></i>&emsp;
                                Shiny was mainly used to build the application.
                                ...
                                <br>&emsp;&emsp;
                                <i class="far fa-arrow-alt-circle-right"></i>&emsp;
                                style.css has been used to style the UI part in this application.
                                
                                <br><br> 
                                <i class="fas fa-arrow-alt-circle-right"></i>&emsp;
                                The Math Eagle character as well as other images created by the author himself. This app aims to improve your mathematical skills and gives the player an Overall Performance Score.
                                
                                <br><br>
                                <i class="fas fa-arrow-alt-circle-right"></i>&emsp;
                                The app was deployed on shinyapps.io . 
                                <br><br> 
                                <i class="fas fa-arrow-alt-circle-right"></i>&emsp;
                                Browse the full source code at <a href="https://github.com/Sharukkhan777/R/tree/master/ShinyContestSubmission">Github</a> .
                                <br><br> 
                               
                                '
                                                
                                           ),
                                           h1(class = "contents4","CONTACT"),
                                           HTML('
                               
                                <i class="fas fa-arrow-alt-circle-right"></i>&emsp;
                                For any enquiries or suggestions, mail to <a href="mailto:sharukkhanstat777@gmail.com">sharukkhanstat777@gmail.com</a>.
                                <br><br>
                                
                                <i class="fas fa-arrow-alt-circle-right"></i>&emsp;
                                For LinkedIn Profile at, <a href="https://www.linkedin.com/in/sharuk-khan-7580b21b9/">LinkedIN</a>.
                                <br><br>'
                                           ),
                                           #-------------------
                                         )
...
server <- function(input, output, session){
  ...
  # calculate the answer
  ques_str <- paste(randnum1, " ", randsym, " ", randnum2, " = ")
  session$userData$ques_str <- ques_str
  ans <- as.character(eval(parse(text=paste(randnum1,randsym, randnum2))))
  session$userData$ans <- ans
  #----------------------------
  runjs(paste('document.getElementById("ans_txt").innerHTML = "', session$userData$ques_str,'";'))
  output$ans_txt <- renderText({session$userData$ques_str})
  print(session$userData$ques_str)
  print( session$userData$ans)
  ans_str_entry <- ""
  ...
  session$userData$data_speed_vector <- c(10)
  # QUESTION DATA
  ...
  observeEvent(input$enter, {
    ...
    if(ans_str_entry == session$userData$ans){
      ...
      # data_question_ans <<- data_question_ans + 1
      session$userData$data_speed_vector <- c(session$userData$data_speed_vector,speed())
      print(session$userData$data_speed_vector)
    ...
    #-----
    session$userData$max_speed <- max(session$userData$data_speed_vector)
    print("speedyyy")
    print(session$userData$max_speed)
    output$max_speed_box <- renderValueBox({
      valueBox(
        paste0(session$userData$max_speed, " miles/min"), "Max Speed", icon = icon("fas fa-rocket"),
        color = "red"
      )
    })
  })
  ...
  output$max_speed_box <- renderValueBox({
    valueBox(
      paste0("10", " miles/min"), "Max Speed", icon = icon("fas fa-rocket"),
      color = "red"
    )
  })
